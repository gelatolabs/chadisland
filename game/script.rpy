...
label chiefHut:
    scene bg chiefHut
    show mc normal at center
    "Home sweet home, probably a good place to save the game in case I get thrown in a volcano later."
    call screen map
...
label plaidHut:
    ...
    if victim == "vlad":
        ...
        plaid "Don't know what that's aboot, eh"
...
label pokemonTriviaWin:
    ...
    dad "How does a penguin build it's house?"
...
label vladAccuseVamp:
    ...
    "With that, Ga(y)d whips out a whole platter of garlic bread out of nowhere."
...
label death:
    ...
    sg "Iunno, chuck him into the volcano?"
    ...
    sg "[pname]! Your reign of terror is totally uncool, my dude. See ya!"
    "The Sun God smacks you into the volcano where you fall to your death. Get fucked lol"
